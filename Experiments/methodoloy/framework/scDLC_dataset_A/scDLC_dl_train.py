...
for method, params in methods.items():
    ...
    config_path = f"../../models/dataset_A/scDLC_dataset_A_{method}_config.json"
    ...
    torch.save(model.state_dict(), f"../../models/dataset_A/scDLC_DL_dataset_A_{method}_pre_train.pth")

per_epoch_results_df = pd.DataFrame(per_epoch_results, columns=['Method', 'Epoch', 'Train_Accuracy', 'Test_Accuracy'])
per_epoch_results_df.to_csv("../../results/dataset_A/scDLC_DL_per_epoch_result_pre_train.csv", index=False)
...
results_df.to_csv("../../results/dataset_A/scDLC_DL_results_pre_train.csv", index=False)
