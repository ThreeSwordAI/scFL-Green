...
for method in methods.keys():
    ...
    model_path = f"../../models/dataset_A/scDLC_DL_dataset_A_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_A/scDLC_DL_test_result_distribution.csv", index=False)
