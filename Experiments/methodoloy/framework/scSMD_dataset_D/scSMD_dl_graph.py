...
# Update result file paths for scSMD DL experiments on dataset_D
pre_train_results_path = "../../results/dataset_D/scSMD_DL_per_epoch_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_D/scSMD_DL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_D/scSMD_DL_results_fine_tune_B.csv"
