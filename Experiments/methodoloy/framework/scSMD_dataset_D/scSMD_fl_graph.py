...
# Update result file paths for scSMD FL experiments on dataset_D
pre_train_results_path = "../../results/dataset_D/scSMD_FL_per_round_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_D/scSMD_FL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_D/scSMD_FL_results_fine_tune_B.csv"
...
# Emission plots
data_path = "../../results/dataset_D/scDLC_FL_Client_A_B_emission.csv"  # if emissions file remains same, update if needed
graph_folder_path = "../../graphs/dataset_D"
