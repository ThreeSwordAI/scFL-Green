...
for client, client_file in clients.items():
    ...
    for method, params in methods.items():
        ...
        pre_trained_path = f"../../models/dataset_D/ACTINN_FL_dataset_D_{method}_pre_train.pth"
        ...
        torch.save(model.state_dict(), f"../../models/dataset_D/ACTINN_FL_dataset_D_{method}_with_fine_tune_{client}.pth")
...
df_results.to_csv("../../results/dataset_D/ACTINN_FL_results_fine_tune.csv", index=False)

df_emissions = pd.DataFrame(emission_results, columns=["Client", "Method", "FineTune", "Emission (kWh)"])
df_emissions.to_csv("../../results/dataset_D/ACTINN_FL_Client_emission.csv", index=False)

print("ACTINN FL Fine-tuning complete for dataset_D. Results saved to CSV.")
