...
# Updated result file paths for scSMD FL experiments on Dataset B:
pre_train_results_path = "../../results/dataset_B/scSMD_FL_per_round_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_B/scSMD_FL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_B/scSMD_FL_results_fine_tune_B.csv"
...
plot_metric(axes[0, 0], data_A, "Accuracy", "scSMD FL Client A - Accuracy per Epoch (Dataset B)", "Accuracy")
plot_metric(axes[0, 1], data_A, "F1 Score", "scSMD FL Client A - F1 Score per Epoch (Dataset B)", "F1 Score")
plot_metric(axes[1, 0], data_B, "Accuracy", "scSMD FL Client B - Accuracy per Epoch (Dataset B)", "Accuracy")
plot_metric(axes[1, 1], data_B, "F1 Score", "scSMD FL Client B - F1 Score per Epoch (Dataset B)", "F1 Score")
...
# Emission plots
data_path = "../../results/dataset_B/scDLC_FL_Client_A_B_emission.csv"  # Update if needed
graph_folder_path = "../../graphs/dataset_B"
