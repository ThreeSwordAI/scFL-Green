...
# Updated file paths for Dataset B
pre_train_results_path = "../../results/dataset_B/scSMD_DL_per_epoch_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_B/scSMD_DL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_B/scSMD_DL_results_fine_tune_B.csv"
...
plt.title("scSMD Deep Learning Train Accuracy per Epoch (Pre-Training) - Dataset B")
plt.xlabel("Epoch")
...
plt.title("scSMD Deep Learning Test Accuracy per Epoch (Pre-Training) - Dataset B")
plt.xlabel("Epoch")
...
plot_metric(axes[0, 0], data_A, "Accuracy", "scSMD DL Client A - Accuracy per Epoch (Dataset B)", "Accuracy")
plot_metric(axes[0, 1], data_A, "F1 Score", "scSMD DL Client A - F1 Score per Epoch (Dataset B)", "F1 Score")
plot_metric(axes[1, 0], data_B, "Accuracy", "scSMD DL Client B - Accuracy per Epoch (Dataset B)", "Accuracy")
plot_metric(axes[1, 1], data_B, "F1 Score", "scSMD DL Client B - F1 Score per Epoch (Dataset B)", "F1 Score")
...
# Emission plots
data_path = "../../results/dataset_B/scDLC_DL_Client_A_B_emission.csv"  # Update if necessary
graph_folder_path = "../../graphs/dataset_B"
...
axes[0].set_title("scSMD DL Carbon Emission for Client A (Dataset B)")
...
axes[1].set_title("scSMD DL Carbon Emission for Client B (Dataset B)")
