...
# Define file paths for dataset_B (CSV files)
...
for method, params in methods.items():
    ...
    config_path = f"../../models/dataset_B/scSMD_FL_dataset_B_{method}_config.json"
    ...
    model_save_path = f"../../models/dataset_B/scSMD_FL_dataset_B_{method}_pre_train.pth"
    torch.save(global_model.state_dict(), model_save_path)
per_round_results_df = pd.DataFrame(all_round_results, columns=['Method', 'Global_Round', 'Test_Accuracy', 'Test_Loss'])
per_round_results_df.to_csv("../../results/dataset_B/scSMD_FL_per_round_result_pre_train.csv", index=False)
...
results_df.to_csv("../../results/dataset_B/scSMD_FL_results_pre_train.csv", index=False)

print("Federated training complete for scSMD on dataset_B. Results saved to CSV.")
