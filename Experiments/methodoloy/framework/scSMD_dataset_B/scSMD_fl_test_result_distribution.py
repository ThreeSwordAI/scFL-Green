...
for method in methods.keys():
    ...
    # Use FL naming convention for the pre-trained model for scSMD FL (dataset_B)
    model_path = f"../../models/dataset_B/scSMD_FL_dataset_B_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_B/scSMD_FL_test_result_distribution.csv", index=False)
