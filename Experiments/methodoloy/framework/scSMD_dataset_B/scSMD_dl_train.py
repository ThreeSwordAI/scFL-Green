...
for method, params in methods.items():
    ...
    config_path = f"../../models/dataset_B/scSMD_dataset_B_{method}_config.json"
    ...
    # Save the pre-training model with updated naming for dataset_B
    torch.save(model.state_dict(), f"../../models/dataset_B/scSMD_DL_dataset_B_{method}_pre_train.pth")

per_epoch_results_df = pd.DataFrame(per_epoch_results, columns=['Method', 'Epoch', 'Train_Accuracy', 'Test_Accuracy'])
per_epoch_results_df.to_csv("../../results/dataset_B/scSMD_DL_per_epoch_result_pre_train.csv", index=False)
...
results_df.to_csv("../../results/dataset_B/scSMD_DL_results_pre_train.csv", index=False)

print("Pre-training complete for scSMD on dataset_B. Results saved to CSV.")
