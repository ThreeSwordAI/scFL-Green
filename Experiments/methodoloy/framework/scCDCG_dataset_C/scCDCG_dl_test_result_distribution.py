...
# Update folder path for dataset_C (CSV files)
...
def process_test_data(file_path):
    ...
    # Assume first 2000 columns are features and column index 2000 contains labels
    ...
    # Return dataset and the category series (for label names)
...
for method in methods.keys():
    ...
    # Updated model file path for scCDCG DL pre-trained model on dataset_C
    model_path = f"../../models/dataset_C/scCDCG_DL_dataset_C_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_C/scCDCG_DL_test_result_distribution.csv", index=False)

print("Test set distribution analysis complete for dataset_C. Results saved.")