...
for method in methods.keys():
    ...
    # Use the FL naming convention for scCDCG FL pre-trained model on dataset_C
    model_path = f"../../models/dataset_C/scCDCG_FL_dataset_C_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_C/scCDCG_FL_test_result_distribution.csv", index=False)
