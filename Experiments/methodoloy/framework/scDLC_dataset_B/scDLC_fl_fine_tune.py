...
# Define file paths and client mapping for Dataset B
...
for client, client_file in clients.items():
    ...
    for method, params in methods.items():
        ...
        torch.save(model.state_dict(), f"../../models/dataset_B/scDLC_FL_dataset_B_{method}_without_fine_tune_{client}.pth")
        ...
        pre_trained_path = f"../../models/dataset_B/scDLC_FL_dataset_B_{method}_pre_train.pth"
        ...
        torch.save(model.state_dict(), f"../../models/dataset_B/scDLC_FL_dataset_B_{method}_with_fine_tune_{client}.pth")
    ...
    df_results.to_csv(f"../../results/dataset_B/scDLC_FL_results_fine_tune_{client}.csv", index=False)
    
# Save overall emissions results
df_emissions = pd.DataFrame(emission_results, columns=["Client", "Method", "FineTune", "Emission (kWh)"])
df_emissions.to_csv(f"../../results/dataset_B/scDLC_FL_Client_A_B_emission.csv", index=False)
