...
for method in methods.keys():
    ...
    model_path = f"../../models/dataset_B/scDLC_FL_dataset_B_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_B/scDLC_FL_test_result_distribution.csv", index=False)
