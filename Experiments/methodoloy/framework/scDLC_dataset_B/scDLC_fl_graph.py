...
pre_train_results_path = "../../results/dataset_B/scDLC_FL_per_round_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_B/scDLC_FL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_B/scDLC_FL_results_fine_tune_B.csv"
...
plt.title("scDLC Federated Learning Test Accuracy per Global Round (Pre-Training) - Dataset B")
...
plt.title("scDLC Federated Learning Test Loss per Global Round (Pre-Training) - Dataset B")
plt.xlabel("Global Round")
...
plot_metric(axes[0, 0], data_A, "Accuracy", "scDLC Federated Learning Client A - Accuracy per Epoch (Dataset B)", "Accuracy")
plot_metric(axes[0, 1], data_A, "F1 Score", "scDLC Federated Learning Client A - F1 Score per Epoch (Dataset B)", "F1 Score")
# Plot Client B Accuracy and F1 Score
plot_metric(axes[1, 0], data_B, "Accuracy", "scDLC Federated Learning Client B - Accuracy per Epoch (Dataset B)", "Accuracy")
plot_metric(axes[1, 1], data_B, "F1 Score", "scDLC Federated Learning Client B - F1 Score per Epoch (Dataset B)", "F1 Score")
...
# Emission plots
data_path = "../../results/dataset_B/scDLC_FL_Client_A_B_emission.csv"
graph_folder_path = "../../graphs/dataset_B"
...
axes[0].set_title("scDLC Federated Learning Carbon Emission for Client A (Dataset B)")
...
axes[1].set_title("scDLC Federated Learning Carbon Emission for Client B (Dataset B)")
