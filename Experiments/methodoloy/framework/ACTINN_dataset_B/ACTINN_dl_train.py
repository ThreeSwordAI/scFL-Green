...
# Set folder path for dataset B (CSV format)
...
# Each CSV has 2001 columns: first 2000 are features and the 2001st is the label
...
for method, params in methods.items():
    ...
    config_path = f"../../models/dataset_B/ACTINN_DL_dataset_B_{method}_config.json"
    ...
    for epoch in range(15):
        ...
        _, f1 = None, f1_score([], [])  # f1 is computed below using test set predictions
    ...
    torch.save(model.state_dict(), f"../../models/dataset_B/ACTINN_DL_dataset_B_{method}_pre_train.pth")
...
per_epoch_results_df.to_csv("../../results/dataset_B/ACTINN_DL_per_epoch_result.csv", index=False)
...
results_df.to_csv("../../results/dataset_B/ACTINN_DL_results.csv", index=False)

print("ACTINN DL pre-training complete for dataset_B. Results saved to CSV.")
