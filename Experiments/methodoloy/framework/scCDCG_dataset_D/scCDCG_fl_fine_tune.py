...
for client, client_file in clients.items():
    ...
    for method, params in methods.items():
        ...
        torch.save(model.state_dict(), f"../../models/dataset_D/scCDCG_FL_dataset_D_{method}_without_fine_tune_{client}.pth")
        ...
        pre_trained_path = f"../../models/dataset_D/scCDCG_FL_dataset_D_{method}_pre_train.pth"
        ...
        torch.save(model.state_dict(), f"../../models/dataset_D/scCDCG_FL_dataset_D_{method}_with_fine_tune_{client}.pth")
    ...
    df_results.to_csv(f"../../results/dataset_D/scCDCG_FL_results_fine_tune_{client}.csv", index=False)
    
df_emissions = pd.DataFrame(emission_results, columns=["Client", "Method", "FineTune", "Emission (kWh)"])
df_emissions.to_csv(f"../../results/dataset_D/scCDCG_FL_Client_A_B_emission.csv", index=False)
