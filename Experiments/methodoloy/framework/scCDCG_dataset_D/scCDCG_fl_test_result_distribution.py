...
for method in methods.keys():
    ...
    model_path = f"../../models/dataset_D/scCDCG_FL_dataset_D_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_D/scCDCG_FL_test_result_distribution.csv", index=False)
