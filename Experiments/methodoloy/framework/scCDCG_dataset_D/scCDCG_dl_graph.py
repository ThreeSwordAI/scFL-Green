...
pre_train_results_path = "../../results/dataset_D/scCDCG_DL_per_epoch_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_D/scCDCG_DL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_D/scCDCG_DL_results_fine_tune_B.csv"
...
file_paths = [
    "../../results/dataset_D/scCDCG_DL_results_fine_tune_A.csv",
    "../../results/dataset_D/scCDCG_DL_results_fine_tune_B.csv"
]
...
file_A = "../../results/dataset_D/scCDCG_DL_results_fine_tune_A.csv"
file_B = "../../results/dataset_D/scCDCG_DL_results_fine_tune_B.csv"
...
# Emission plots
data_path = "../../results/dataset_D/scDLC_DL_Client_A_B_emission.csv"  # If emission file is not changed, you might want to update this name too.
graph_folder_path = "../../graphs/dataset_D"
