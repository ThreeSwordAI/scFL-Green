...
for method in methods.keys():
    ...
    # Model file path for scSMD DL pre-trained model (dataset_C)
    model_path = f"../../models/dataset_C/scSMD_DL_dataset_C_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_C/scSMD_DL_test_result_distribution.csv", index=False)
