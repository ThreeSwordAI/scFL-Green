...
# File paths for ACTINN FL experiments on dataset A
pre_train_results_path = "../../results/dataset_A/ACTINN_FL_per_round_result.csv"
fine_tune_results_A_path = "../../results/dataset_A/ACTINN_FL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_A/ACTINN_FL_results_fine_tune_B.csv"
...
plt.title("ACTINN Federated Learning Test Accuracy per Global Round (Pre-Training)")
...
plt.title("ACTINN Federated Learning Test Loss per Global Round (Pre-Training)")
plt.xlabel("Global Round")
plt.ylabel("Test Loss")
plt.legend(title="Method")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/pdf/ACTINN_FL_test_accuracy_loss.pdf")
plt.savefig(f"{graph_folder_path}/png/ACTINN_FL_test_accuracy_loss.png")
plt.close()
...
plot_metric(axes[0, 0], data_A, "Accuracy", "ACTINN Federated Learning Client A - Accuracy per Epoch", "Accuracy")
plot_metric(axes[0, 1], data_A, "F1 Score", "ACTINN Federated Learning Client A - F1 Score per Epoch", "F1 Score")
plot_metric(axes[1, 0], data_B, "Accuracy", "ACTINN Federated Learning Client B - Accuracy per Epoch", "Accuracy")
plot_metric(axes[1, 1], data_B, "F1 Score", "ACTINN Federated Learning Client B - F1 Score per Epoch", "F1 Score")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/png/ACTINN_FL_FineTune_Results.png", dpi=300)
plt.savefig(f"{graph_folder_path}/pdf/ACTINN_FL_FineTune_Results.pdf")
plt.close()

# Emission plots
data_path = "../../results/dataset_A/ACTINN_FL_Client_A_B_emission.csv"
graph_folder_path = "../../graphs/dataset_A"
...
axes[0].set_title("ACTINN Federated Learning Carbon Emission for Client A")
...
axes[1].set_title("ACTINN Federated Learning Carbon Emission for Client B")
