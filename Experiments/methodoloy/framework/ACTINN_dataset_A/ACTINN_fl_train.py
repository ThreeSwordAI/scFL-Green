...
for method, params in methods.items():
    ...
    config_path = f"../../models/dataset_A/ACTINN_FL_dataset_A_{method}_config.json"
    ...
    torch.save(global_model.state_dict(), f"../../models/dataset_A/ACTINN_FL_dataset_A_{method}_pre_train.pth")

per_round_results_df = pd.DataFrame(all_round_results, columns=['Method', 'Global_Round', 'Test_Accuracy', 'Test_Loss'])
per_round_results_df.to_csv("../../results/dataset_A/ACTINN_FL_per_round_result.csv", index=False)
...
results_df.to_csv("../../results/dataset_A/ACTINN_FL_results.csv", index=False)
