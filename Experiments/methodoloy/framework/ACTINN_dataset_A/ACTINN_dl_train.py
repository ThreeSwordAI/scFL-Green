...
# Define file paths (using dataset_A in AnnData format)
...
for method, params in methods.items():
    ...
    config_path = f"../../models/dataset_A/ACTINN_DL_dataset_A_{method}_config.json"
    ...
    torch.save(model.state_dict(), f"../../models/dataset_A/ACTINN_DL_dataset_A_{method}_pre_train.pth")
...
per_epoch_results_df.to_csv("../../results/dataset_A/ACTINN_DL_per_epoch_result.csv", index=False)
...
results_df.to_csv("../../results/dataset_A/ACTINN_DL_results.csv", index=False)
