...
# Update result file paths for scCDCG DL experiments
pre_train_results_path = "../../results/dataset_A/scCDCG_DL_per_epoch_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_A/scCDCG_DL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_A/scCDCG_DL_results_fine_tune_B.csv"
...
plt.title("scCDCG Deep Learning Train Accuracy per Epoch (Pre-Training)")
plt.xlabel("Epoch")
...
plt.title("scCDCG Deep Learning Test Accuracy per Epoch (Pre-Training)")
plt.xlabel("Epoch")
plt.ylabel("Test Accuracy")
plt.legend(title="Method")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/pdf/scCDCG_DL_train_vs_test_accuracy.pdf")
plt.savefig(f"{graph_folder_path}/png/scCDCG_DL_train_vs_test_accuracy.png")
plt.close()

file_paths = [
    "../../results/dataset_A/scCDCG_DL_results_fine_tune_A.csv",
    "../../results/dataset_A/scCDCG_DL_results_fine_tune_B.csv"
]
...
file_A = "../../results/dataset_A/scCDCG_DL_results_fine_tune_A.csv"
file_B = "../../results/dataset_A/scCDCG_DL_results_fine_tune_B.csv"
...
plot_metric(axes[0, 0], data_A, "Accuracy", "scCDCG Deep Learning Client A - Accuracy per Epoch", "Accuracy")
# Plot Client A F1 Score
plot_metric(axes[0, 1], data_A, "F1 Score", "scCDCG Deep Learning Client A - F1 Score per Epoch", "F1 Score")
# Plot Client B Accuracy
plot_metric(axes[1, 0], data_B, "Accuracy", "scCDCG Deep Learning Client B - Accuracy per Epoch", "Accuracy")
# Plot Client B F1 Score
plot_metric(axes[1, 1], data_B, "F1 Score", "scCDCG Deep Learning Client B - F1 Score per Epoch", "F1 Score")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/png/scCDCG_DL_FineTune_Results.png", dpi=300)
plt.savefig(f"{graph_folder_path}/pdf/scCDCG_DL_FineTune_Results.pdf")
#plt.show()

# Emission plots
data_path = "../../results/dataset_A/scDLC_DL_Client_A_B_emission.csv"  # If emission file is not changed, you might want to update this name too.
graph_folder_path = "../../graphs/dataset_A"
...
axes[0].set_title("scCDCG Deep Learning Carbon Emission for Client A")
...
axes[1].set_title("scCDCG Deep Learning Carbon Emission for Client B")
axes[1].set_ylabel("Emission (kWh)")
axes[1].set_xlabel("Method")
axes[1].legend(title="Fine-Tune")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/png/scCDCG_Client_A_B_Emission.png", dpi=300)
plt.savefig(f"{graph_folder_path}/pdf/scCDCG_Client_A_B_Emission.pdf")
