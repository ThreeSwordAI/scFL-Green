...
for method in methods.keys():
    ...
    # Use the FL naming convention for the pre-trained model for scCDCG
    model_path = f"../../models/dataset_A/scCDCG_FL_dataset_A_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_A/scCDCG_FL_test_result_distribution.csv", index=False)
