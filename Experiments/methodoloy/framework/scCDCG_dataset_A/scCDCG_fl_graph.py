...
# Update result file paths for scCDCG FL experiments:
pre_train_results_path = "../../results/dataset_A/scCDCG_FL_per_round_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_A/scCDCG_FL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_A/scCDCG_FL_results_fine_tune_B.csv"
...
# Emission plots
data_path = "../../results/dataset_A/scDLC_FL_Client_A_B_emission.csv"  # Update if needed
graph_folder_path = "../../graphs/dataset_A"
