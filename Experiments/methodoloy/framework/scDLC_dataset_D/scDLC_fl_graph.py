...
# Updated result file paths for FL experiments:
pre_train_results_path = "../../results/dataset_D/scDLC_FL_per_round_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_D/scDLC_FL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_D/scDLC_FL_results_fine_tune_B.csv"
...
plt.title("scDLC Federated Learning Test Accuracy per Global Round (Pre-Training)")
...
plt.title("scDLC Federated Learning Test Loss per Global Round (Pre-Training)")
plt.xlabel("Global Round")
plt.ylabel("Test Loss")
plt.legend(title="Method")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/pdf/scDLC_FL_test_accuracy_loss.pdf")
plt.savefig(f"{graph_folder_path}/png/scDLC_FL_test_accuracy_loss.png")
plt.close()
...
plot_metric(axes[0, 0], data_A, "Accuracy", "scDLC Federated Learning Client A - Accuracy per Epoch", "Accuracy")
plot_metric(axes[0, 1], data_A, "F1 Score", "scDLC Federated Learning Client A - F1 Score per Epoch", "F1 Score")
# Plot Client B Accuracy and F1 Score
plot_metric(axes[1, 0], data_B, "Accuracy", "scDLC Federated Learning Client B - Accuracy per Epoch", "Accuracy")
plot_metric(axes[1, 1], data_B, "F1 Score", "scDLC Federated Learning Client B - F1 Score per Epoch", "F1 Score")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/png/scDLC_FL_FineTune_Results.png", dpi=300)
plt.savefig(f"{graph_folder_path}/pdf/scDLC_FL_FineTune_Results.pdf")
#plt.show()

# Emission plots
data_path = "../../results/dataset_D/scDLC_FL_Client_A_B_emission.csv"
graph_folder_path = "../../graphs/dataset_D"
...
axes[0].set_title("scDLC Federated Learning Carbon Emission for Client A")
...
axes[1].set_title("scDLC Federated Learning Carbon Emission for Client B")
axes[1].set_ylabel("Emission (kWh)")
axes[1].set_xlabel("Method")
axes[1].legend(title="Fine-Tune")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/png/scDLC_FL_Client_A_B_Emission.png", dpi=300)
plt.savefig(f"{graph_folder_path}/pdf/scDLC_FL_Client_A_B_Emission.pdf")
