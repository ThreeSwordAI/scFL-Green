...
# Update result file paths for scCDCG DL experiments on dataset_B
pre_train_results_path = "../../results/dataset_B/scCDCG_DL_per_epoch_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_B/scCDCG_DL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_B/scCDCG_DL_results_fine_tune_B.csv"
graph_folder_path = "../../graphs/dataset_B"
...
# Emission plots
data_path = "../../results/dataset_A/scDLC_DL_Client_A_B_emission.csv"  # If your emissions file name remains unchanged, update if necessary.
graph_folder_path = "../../graphs/dataset_B"
