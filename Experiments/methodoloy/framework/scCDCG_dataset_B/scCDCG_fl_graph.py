...
# Update result file paths for scCDCG FL experiments on dataset_B
pre_train_results_path = "../../results/dataset_B/scCDCG_FL_per_round_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_B/scCDCG_FL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_B/scCDCG_FL_results_fine_tune_B.csv"
