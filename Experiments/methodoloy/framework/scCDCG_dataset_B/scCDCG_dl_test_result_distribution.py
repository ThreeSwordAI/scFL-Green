...
for method in methods.keys():
    ...
    # Updated model file path for scCDCG DL pre-trained model on dataset_B
    model_path = f"../../models/dataset_B/scCDCG_DL_dataset_B_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_B/scCDCG_DL_test_result_distribution.csv", index=False)
