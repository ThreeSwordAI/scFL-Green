...
# Update output directories to use dataset_C
...
for method, params in methods.items():
    ...
    config_path = f"../../models/dataset_C/scDLC_dataset_C_{method}_config.json"
    ...
    # Save the pre-training model with updated naming (C)
    torch.save(model.state_dict(), f"../../models/dataset_C/scDLC_DL_dataset_C_{method}_pre_train.pth")

per_epoch_results_df = pd.DataFrame(per_epoch_results, columns=['Method', 'Epoch', 'Train_Accuracy', 'Test_Accuracy'])
per_epoch_results_df.to_csv("../../results/dataset_C/scDLC_DL_per_epoch_result_pre_train.csv", index=False)
...
results_df.to_csv("../../results/dataset_C/scDLC_DL_results_pre_train.csv", index=False)
