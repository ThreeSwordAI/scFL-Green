...
for method, params in methods.items():
    ...
    config_path = f"../../models/dataset_C/scDLC_FL_dataset_C_{method}_config.json"
    ...
    model_save_path = f"../../models/dataset_C/scDLC_FL_dataset_C_{method}_pre_train.pth"
...
per_round_results_df.to_csv("../../results/dataset_C/scDLC_FL_per_round_result_pre_train.csv", index=False)
...
results_df.to_csv("../../results/dataset_C/scDLC_FL_results_pre_train.csv", index=False)
