...
def process_test_data(file_path):
    # Read CSV: first 2000 columns are features, 2001st column is the label
...
# Process test data from Dataset B (chunk 7)
...
for method in methods.keys():
    ...
    # Use FL naming convention for the pre-trained model
    model_path = f"../../models/dataset_C/scDLC_FL_dataset_C_{method}_pre_train.pth"
...
df_results.to_csv("../../results/dataset_C/scDLC_FL_test_result_distribution.csv", index=False)
