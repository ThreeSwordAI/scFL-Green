...
# Update result file paths for scSMD FL experiments on dataset_A
pre_train_results_path = "../../results/dataset_A/scSMD_FL_per_round_result_pre_train.csv"
fine_tune_results_A_path = "../../results/dataset_A/scSMD_FL_results_fine_tune_A.csv"
fine_tune_results_B_path = "../../results/dataset_A/scSMD_FL_results_fine_tune_B.csv"
...
plt.title("scSMD Federated Learning Test Accuracy per Global Round (Pre-Training)")
...
plt.title("scSMD Federated Learning Test Loss per Global Round (Pre-Training)")
plt.xlabel("Global Round")
...
# Update fine-tuning CSV file names for FL results
file_paths = [
...
plot_metric(axes[0, 0], data_A, "Accuracy", "scSMD Federated Learning Client A - Accuracy per Epoch", "Accuracy")
plot_metric(axes[0, 1], data_A, "F1 Score", "scSMD Federated Learning Client A - F1 Score per Epoch", "F1 Score")
plot_metric(axes[1, 0], data_B, "Accuracy", "scSMD Federated Learning Client B - Accuracy per Epoch", "Accuracy")
plot_metric(axes[1, 1], data_B, "F1 Score", "scSMD Federated Learning Client B - F1 Score per Epoch", "F1 Score")
...
# Emission plots
data_path = "../../results/dataset_A/scDLC_FL_Client_A_B_emission.csv"  # if emissions file remains same, update if needed
graph_folder_path = "../../graphs/dataset_A"
...
axes[0].set_title("scSMD Federated Learning Carbon Emission for Client A")
...
axes[1].set_title("scSMD Federated Learning Carbon Emission for Client B")
axes[1].set_ylabel("Emission (kWh)")
axes[1].set_xlabel("Method")
axes[1].legend(title="Fine-Tune")

plt.tight_layout()
plt.savefig(f"{graph_folder_path}/png/scSMD_FL_Client_A_B_Emission.png", dpi=300)
plt.savefig(f"{graph_folder_path}/pdf/scSMD_FL_Client_A_B_Emission.pdf")
plt.close()
