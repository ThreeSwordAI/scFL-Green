...
# Load the dataset
adata = sc.read_h5ad("../raw_data/dataset_D/dataset_D.h5ad")
...
with open("../processed_data/dataset_D/dataset_D_label_mapping.txt", "w") as f:
...
for i in range(num_chunks):
    ...
    # Save as .h5ad file
    chunk_adata.write(f"../processed_data/dataset_D/dataset_D_chunk_{i + 1}.h5ad")
    print(f"Saved dataset_D_chunk_{i + 1}.h5ad with shape {chunk_adata.shape}, ensuring transcriptomic data is included.")
