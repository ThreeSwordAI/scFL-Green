setwd("/mnt/f/FAU/Course/winter25/BioNet Project/oFed-sc/methodoloy/raw_data/dataset_B")
...
write.table(dat,"selectgene_dataset_B.csv",row.names = FALSE,col.names = FALSE,sep=',')
