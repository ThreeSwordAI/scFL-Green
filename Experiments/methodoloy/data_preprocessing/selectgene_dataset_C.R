setwd("/mnt/f/FAU/Course/winter25/BioNet Project/oFed-sc/methodoloy/raw_data/dataset_C")

gene_no_list <- 2000
data <- read.table("GSE84133.csv",sep=',')
cdata <- data[-1,-1]
...
write.table(dat,"selectgene_dataset_C.csv",row.names = FALSE,col.names = FALSE,sep=',')
